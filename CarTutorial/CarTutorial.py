...
# parent class
class Vehicle:
    def __init__(self, colour="blue", x=400, y=400):
        # parent attributes
...
class Truck(Vehicle):
    def __init__(self, x, y, kind="truck_tractor"):
        # initialize parent
        super().__init__(colour="green") #inheit all attributes and methods of  parent class of vehicle
...
class Police(Vehicle):
    def __init__(self, x, y):
        # initialize parent
        super().__init__() #inheit all attributes and methods of parent class of vehicle
        # override parent attributes
...
truck = Truck(random.randint(0,800), random.randint(0,800))
truck2 = Truck(random.randint(0,800), random.randint(0,800),"box_truck")
print(truck.img_path, truck.location)
...
screen.blit(truck2.img, truck2.img_location)
